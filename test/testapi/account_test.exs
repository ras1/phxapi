defmodule Testapi.AccountTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{email: "some email",  is_active: false, password: "some password"}
    @update_attrs %{email: "some updated email", is_active: true, password: "some updated password" }
